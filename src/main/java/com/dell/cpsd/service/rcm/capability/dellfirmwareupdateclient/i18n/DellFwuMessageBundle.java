...
public class DellFwuMessageBundle extends ListResourceBundle
{
    ...
    private static final Object[][] CONTENTS = {{"FWU2001E", "FWU2001E Rabbit consumer [{0}] threw an error. Reason [{1}]"},
            ...
            {"FWU2003I", "FWU2003I The compliance data producer routing key : [{0}]"},
            {"FWU2004I", "FWU2004I The compliance data consumer queue name : [{0}]"},
            {"FWU2005I", "FWU2005I The compliance data consumer binding key: [{0}]"},
            {"FWU2006E", "FWU2006E Error publishing compliance data message [{0}]. Reason [{1}]"},
            {"FWU2007W", "FWU2007W The compliance data message to handle is null."},
            {"FWU2008W", "FWU2008W The compliance error message to handle is null."},
            {"FWU2009W", "FWU2009W The compliance data message handler is not set."},
